...
namespace PerpustakaanAppMVC.View
{
    public partial class FrmEntryMahasiswa : Form
    {
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            if (isNewData) // tambah data baru, panggil method Create
            {
                ...
                if (result > 0) // tambah data berhasil
                {
                    ...
                    txtNpm.Text = string.Empty;
                    txtNama.Text = string.Empty;
                    txtAngkatan.Text = string.Empty;
                    txtNpm.Focus();
                }
            }
        ...
        private void txtNpm_Click(object sender, EventArgs e)
        {
        ...
        private void txtAngkatan_Click(object sender, EventArgs e)
        {
